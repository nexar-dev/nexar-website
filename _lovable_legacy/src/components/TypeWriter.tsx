...
interface TypeWriterProps {
  text: string;
  /** Highlighted portion that gets the gradient class */
  highlight?: string;
...
export default function TypeWriter({
  ...
  // Build the displayed text with highlight support
  const renderText = () => {
    ...
    // Split into before, highlight, after portions based on what's been typed
    ...
    const shownHighlight = displayCount > highlightStart
      ...
      : "";
    const shownAfter = displayCount > highlightEnd
      ? shown.slice(highlightEnd)
      : "";
