...
const meetings = [
  {
    ...
    desc: "Ouvimos suas necessidades com atenção para criar uma solução que realmente resolva seus problemas.",
  },
  {
    icon: CalendarCheck,
    title: "Acompanhamento frequente",
    desc: "Reuniões periódicas para alinhar expectativas, validar entregas e garantir que tudo saia como planejado.",
  },
  {
    icon: Presentation,
    title: "Apresentação do sistema",
    desc: "Demonstramos cada funcionalidade desenvolvida para que você acompanhe a evolução do seu sistema.",
  },
  {
    icon: Video,
    title: "Suporte contínuo",
    desc: "Após a entrega, continuamos disponíveis para ajustes, melhorias e treinamento da sua equipe.",
  },
];
